...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CategoryDto&&(identical(other.slug, slug) || other.slug == slug)&&(identical(other.name, name) || other.name == name)&&(identical(other.url, url) || other.url == url));
}
...
@override
String toString() {
  return 'CategoryDto(slug: $slug, name: $name, url: $url)';
}
...
class _CategoryDto implements CategoryDto {
  const _CategoryDto({required this.slug, required this.name, this.url = ''});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CategoryDto&&(identical(other.slug, slug) || other.slug == slug)&&(identical(other.name, name) || other.name == name)&&(identical(other.url, url) || other.url == url));
}
